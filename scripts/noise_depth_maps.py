...
parser.add_argument(
    "input_dir", 
    type=str, 
    help="path to the input directory with depth maps"
)
parser.add_argument(
    "output_dir", 
    type=str, 
...
parser.add_argument(
    ...
    help="type of the noise (additive or multiplicative)",
)
parser.add_argument(
    "--noise_stddev",
    type=float,
    default=0.1,
    help="Standard deviation of the Gaussian noise (in depth units)",
)
