...
parser.add_argument("--output_cam_model", type=str,
...
parser.add_argument("--fov", type=float,  help="The field of view of fisheye camera used in FOV camera model.")
parser.add_argument("--output_type", type=str, choices=["BIN", "TXT", "NVM"], default="TXT", 
...
def main(args):
    ...
    if args.output_cam_model is not None:
        ...
        for cam_id, cam in colmap_model.cameras.items():
            ...
            elif args.output_cam_model == "SIMPLE_RADIAL" or args.output_cam_model == "SIMPLE_RADIAL_FISHEYE":
                # f, cx, cy, k
                new_params = [fx, cx, cy, k1]
            elif args.output_cam_model == "RADIAL" or args.output_cam_model == "RADIAL_FISHEYE":
                # f, cx, cy, k1, k2
            ...
            colmap_model.cameras[cam_id] = pycolmap.Camera(model=args.output_cam_model,
                                                           width=cam.width,
                                                           height=cam.height,
                                                           params=new_params)
