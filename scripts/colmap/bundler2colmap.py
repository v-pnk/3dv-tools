...
parser = argparse.ArgumentParser(
    description="Evaluation tool", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
parser.add_argument("bundle_model", type=str,
...
def read_bundler(file_path, img_list):
    ...
    for line in tqdm(f):
        ...
        if cam_iter < num_cams:
            ...
            cam_data["R"] = np.array([[Rw0[0], Rw0[1], Rw0[2]],
                                      [-Rw1[0], -Rw1[1], -Rw1[2]],
                                      [-Rw2[0], -Rw2[1], -Rw2[2]]])
